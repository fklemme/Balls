...
Spielfeld::Spielfeld(int breite, int hoehe)
	: m_breite(breite), m_hoehe(hoehe)
{
	sAppName = "Balls";
...
bool Spielfeld::Draw(int32_t x, int32_t y, olc::Pixel p) {
	return olc::PixelGameEngine::Draw(x + 1, y + 1, p);
}
